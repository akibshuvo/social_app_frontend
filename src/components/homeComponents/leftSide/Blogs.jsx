...
const Blogs = () => {
  return (
    <div className=' box-border w-280px bg-whit mt-8 shadow-xl h-[480px]  py-8 rounded-xl'>
        ...
        <div className='flex items-center gap-x-4 mb-5 px-4 hover:cursor-pointer hover:bg-main_bg'>
            <div className='w-16'><img className='rounded-md' src={b1} alt="" /></div>
            <div>
                <h5 className='font-girloy_bold'>Clean floor.</h5>
                <p className='font-girloy_light'>Create a unique blog <br/> and share you friend</p>
            </div>
        </div>

        <div className='flex items-center gap-x-4 mb-5 px-4 hover:cursor-pointer hover:bg-main_bg w-full'>
            <div className='w-16'><img className='rounded-md' src={b2} alt="" /></div>
            <div>
                <h5 className='font-girloy_bold'>Post Here.</h5>
                <p className='font-girloy_light'>Create a unique blog <br/> and share you friend</p>
            </div>
        </div>
